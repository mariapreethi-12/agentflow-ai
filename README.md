...
To enable real PM/PRD generation, copy `backend/.env.example` to `backend/.env` and set `OPENAI_API_KEY`. Without a key, AgentFlow uses deterministic fallback artifacts.
